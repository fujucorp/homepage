...
{
	/// <summary>
	/// Identify_Standard6 資料表 Entity 類別
	/// </summary>
	[Serializable]
	[EntitySpec(TABLE_NAME, TableTypeEnum.Table)]
	public partial class IdentifyStandard6Entity : Entity
	{
		public const string TABLE_NAME = "Identify_Standard6";

		#region Field Name Const Class
		/// <summary>
		/// IdentifyStandard6Entity 欄位名稱定義抽象類別
		/// </summary>
		...
		#region Constructor
		/// <summary>
		/// IdentifyStandard6Entity 類別建構式
		/// </summary>
		public IdentifyStandard6Entity()
			: base()
		{
		}
		#endregion
