...
{
	/// <summary>
	/// Identify_Standard5 資料表 Entity 類別
	/// </summary>
	[Serializable]
	[EntitySpec(TABLE_NAME, TableTypeEnum.Table)]
	public partial class IdentifyStandard5Entity : Entity
	{
		public const string TABLE_NAME = "Identify_Standard5";

		#region Field Name Const Class
		/// <summary>
		/// IdentifyStandard5Entity 欄位名稱定義抽象類別
		/// </summary>
		...
		#region Constructor
		/// <summary>
		/// IdentifyStandard5Entity 類別建構式
		/// </summary>
		public IdentifyStandard5Entity()
			: base()
		{
		}
		#endregion
