...
namespace Entities
{
    ...
    public partial class DeptListEntity : Entity
    {
        ...
        #region [MDY:202203XX] 2022擴充案 部別代碼型別調整
        private string _DeptId = null;
        /// <summary>
        /// 部別代碼
        /// </summary>
        [FieldSpec(Field.DeptId, true, FieldTypeEnum.NVarChar, 40, false)]
        ...
        #region Data
        #region [MDY:202203XX] 2022擴充案 部別名稱型別調整
        /// <summary>
        /// 部別名稱
        /// </summary>
        [FieldSpec(Field.DeptName, false, FieldTypeEnum.NVarChar, 40, true)]
        ...
        /// 部別英文名稱
        /// </summary>
        [FieldSpec(Field.DeptEName, false, FieldTypeEnum.NVarChar, 40, true)]
