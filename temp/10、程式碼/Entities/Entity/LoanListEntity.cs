...
namespace Entities
{
	...
	public partial class LoanListEntity : Entity
	{
		...
		#region [MDY:202203XX] 2022擴充案 就貸代碼型別調整為 NVarChar(40)
		private string _LoanId = null;
		/// <summary>
		/// 就貸代碼
		/// </summary>
		[FieldSpec(Field.LoanId, true, FieldTypeEnum.NVarChar, 40, false)]
		...
		#region Data
		#region [MDY:202203XX] 2022擴充案 就貸名稱型別調整為 NVarChar(40)
		/// <summary>
		/// 就貸名稱
		/// </summary>
		[FieldSpec(Field.LoanName, false, FieldTypeEnum.NVarChar, 40, true)]
		...
		/// 就貸英文名稱
		/// </summary>
		[FieldSpec(Field.LoanEName, false, FieldTypeEnum.NVarChar, 40, true)]
