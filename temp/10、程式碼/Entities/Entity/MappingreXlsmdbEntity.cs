...
namespace Entities
{
    ...
    public partial class MappingreXlsmdbEntity : Entity
    {
        ...
        public XlsMapField[] GetMapFields()
        {
            ...
            {
                mapFields.Add(new XlsMapField(Field.DeptEName, this.DeptEName, new WordChecker(1, 40)));
            }

            if (!String.IsNullOrWhiteSpace(this.CollegeEName)) //CollegeListEntity
            {
                mapFields.Add(new XlsMapField(Field.CollegeEName, this.CollegeEName, new WordChecker(1, 40)));
            }

            if (!String.IsNullOrWhiteSpace(this.MajorEName)) //MajorListEntity
            {
                mapFields.Add(new XlsMapField(Field.MajorEName, this.MajorEName, new WordChecker(1, 40)));
            }

            if (!String.IsNullOrWhiteSpace(this.ClassEName)) //ClassListEntity
            {
                mapFields.Add(new XlsMapField(Field.ClassEName, this.ClassEName, new WordChecker(1, 40)));
            }
            #endregion
            ...
            {
                mapFields.Add(new XlsMapField(Field.ReduceEName, this.ReduceEName, new WordChecker(1, 40)));
            }

            if (!String.IsNullOrWhiteSpace(this.DormEName)) //DormListEntity
            {
                mapFields.Add(new XlsMapField(Field.DormEName, this.DormEName, new WordChecker(1, 40)));
            }

            if (!String.IsNullOrWhiteSpace(this.LoanEName)) //LoanListEntity
            {
                mapFields.Add(new XlsMapField(Field.LoanEName, this.LoanEName, new WordChecker(1, 40)));
            }
            #endregion
            ...
            #region 身分註記英文名稱對照欄位 (StudentReceiveEntity, IdentifyList1Entity, IdentifyList2Entity, IdentifyList3Entity, IdentifyList4Entity, IdentifyList5Entity, IdentifyList6Entity)
            {
                ...
                {
                    mapFields.Add(new XlsMapField(Field.IdentifyEName1, this.IdentifyEName1, new WordChecker(1, 40)));
                }

                if (!String.IsNullOrWhiteSpace(this.IdentifyEName2)) //IdentifyList2Entity
                {
                    mapFields.Add(new XlsMapField(Field.IdentifyEName2, this.IdentifyEName2, new WordChecker(1, 40)));
                }

                if (!String.IsNullOrWhiteSpace(this.IdentifyEName3)) //IdentifyList3Entity
                {
                    mapFields.Add(new XlsMapField(Field.IdentifyEName3, this.IdentifyEName3, new WordChecker(1, 40)));
                }

                if (!String.IsNullOrWhiteSpace(this.IdentifyEName4)) //IdentifyList4Entity
                {
                    mapFields.Add(new XlsMapField(Field.IdentifyEName4, this.IdentifyEName4, new WordChecker(1, 40)));
                }

                if (!String.IsNullOrWhiteSpace(this.IdentifyEName5)) //IdentifyList5Entity
                {
                    mapFields.Add(new XlsMapField(Field.IdentifyEName5, this.IdentifyEName5, new WordChecker(1, 40)));
                }

                if (!String.IsNullOrWhiteSpace(this.IdentifyEName6)) //IdentifyList6Entity
                {
                    mapFields.Add(new XlsMapField(Field.IdentifyEName6, this.IdentifyEName6, new WordChecker(1, 40)));
                }
            }
            #endregion
            #endregion
        ...
        #region [MDY:202203XX] 2022擴充案 收入科目英文名稱相關 Method
        /// <summary>
        /// 取得指定編號的收入科目英文名稱
        /// </summary>
        ...
        #region [MDY:202203XX] 2022擴充案 備註項目英文標題相關 Method
        /// <summary>
        /// 取得指定編號的備註項目英文標題
        /// </summary>
