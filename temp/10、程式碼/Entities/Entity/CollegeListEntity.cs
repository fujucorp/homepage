...
namespace Entities
{
	...
	public partial class CollegeListEntity : Entity
	{
		...
		#region [MDY:202203XX] 2022擴充案 院別代碼型別調整為 NVarChar(40)
		private string _CollegeId = null;
		/// <summary>
		/// 院別代碼
		/// </summary>
		[FieldSpec(Field.CollegeId, true, FieldTypeEnum.NVarChar, 40, false)]
		...
		#region Data
		#region [MDY:202203XX] 2022擴充案 院別名稱型別調整為 NVarChar(40)
		/// <summary>
		/// 院別名稱
		/// </summary>
		...
		/// 院別英文名稱
		/// </summary>
		[FieldSpec(Field.CollegeEName, false, FieldTypeEnum.NVarChar, 40, true)]
