...
{
	/// <summary>
	/// Identify_Standard1 資料表 Entity 類別
	/// </summary>
	[Serializable]
	[EntitySpec(TABLE_NAME, TableTypeEnum.Table)]
	public partial class IdentifyStandard1Entity : Entity
	{
		public const string TABLE_NAME = "Identify_Standard1";

		#region Field Name Const Class
		/// <summary>
		/// IdentifyStandard1Entity 欄位名稱定義抽象類別
		/// </summary>
		...
		#region Constructor
		/// <summary>
		/// IdentifyStandard1Entity 類別建構式
		/// </summary>
		public IdentifyStandard1Entity()
			: base()
		{
		}
		#endregion
