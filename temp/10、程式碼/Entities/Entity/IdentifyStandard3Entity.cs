...
{
	/// <summary>
	/// Identify_Standard3 資料表 Entity 類別
	/// </summary>
	[Serializable]
	[EntitySpec(TABLE_NAME, TableTypeEnum.Table)]
	public partial class IdentifyStandard3Entity : Entity
	{
		public const string TABLE_NAME = "Identify_Standard3";

		#region Field Name Const Class
		/// <summary>
		/// IdentifyStandard3Entity 欄位名稱定義抽象類別
		/// </summary>
		...
		#region Constructor
		/// <summary>
		/// IdentifyStandard3Entity 類別建構式
		/// </summary>
		public IdentifyStandard3Entity()
			: base()
		{
		}
		#endregion
