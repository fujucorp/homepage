...
namespace Entities
{
	...
	public partial class DormListEntity : Entity
	{
		...
		#region [MDY:202203XX] 2022擴充案 住宿代碼型別調整為 NVarChar(40)
		private string _DormId = null;
		/// <summary>
		/// 住宿代碼 欄位屬性
		/// </summary>
		[FieldSpec(Field.DormId, true, FieldTypeEnum.NVarChar, 40, false)]
		...
		#region Data
		#region [MDY:202203XX] 2022擴充案 住宿名稱型別調整為 NVarChar(40)
		/// <summary>
		/// 住宿名稱 欄位屬性
		/// </summary>
		[FieldSpec(Field.DormName, false, FieldTypeEnum.NVarChar, 40, true)]
		...
		/// 住宿英文名稱
		/// </summary>
		[FieldSpec(Field.DormEName, false, FieldTypeEnum.NVarChar, 40, true)]
