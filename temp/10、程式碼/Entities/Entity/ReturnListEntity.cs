...
namespace Entities
{
	...
	public partial class ReturnListEntity : Entity
	{
		...
		#region [MDY:202203XX] 2022擴充案 退費代碼型別調整為 NVarChar(40)
		private string _ReturnId = null;
		/// <summary>
		/// 退費代碼
		/// </summary>
		[FieldSpec(Field.ReturnId, true, FieldTypeEnum.NVarChar, 40, false)]
		...
		#region Data
		#region [MDY:202203XX] 2022擴充案 退費名稱型別調整為 NVarChar(40)
		/// <summary>
		/// 退費名稱
		/// </summary>
		[FieldSpec(Field.ReturnName, false, FieldTypeEnum.NVarChar, 40, true)]
		...
		/// 退費英文名稱
		/// </summary>
		[FieldSpec(Field.ReturnEName, false, FieldTypeEnum.NVarChar, 40, true)]
