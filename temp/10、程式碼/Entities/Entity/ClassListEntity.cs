...
namespace Entities
{
	...
	public partial class ClassListEntity : Entity
	{
		...
		#region [MDY:202203XX] 2022擴充案 班別代碼型別調整為 NVarChar(40)
		private string _ClassId = null;
		/// <summary>
		/// 班別代碼
		/// </summary>
		[FieldSpec(Field.ClassId, true, FieldTypeEnum.NVarChar, 40, false)]
		...
		#region Data
		#region [MDY:202203XX] 2022擴充案 班別名稱型別調整為 NVarChar(40)
		/// <summary>
		/// 班別名稱
		/// </summary>
		...
		/// 班別英文名稱
		/// </summary>
		[FieldSpec(Field.ClassEName, false, FieldTypeEnum.NVarChar, 40, true)]
