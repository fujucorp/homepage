...
{
	/// <summary>
	/// Identify_Standard2 資料表 Entity 類別
	/// </summary>
	[Serializable]
	[EntitySpec(TABLE_NAME, TableTypeEnum.Table)]
	public partial class IdentifyStandard2Entity : Entity
	{
		public const string TABLE_NAME = "Identify_Standard2";

		#region Field Name Const Class
		/// <summary>
		/// IdentifyStandard2Entity 欄位名稱定義抽象類別
		/// </summary>
		...
		#region Constructor
		/// <summary>
		/// IdentifyStandard2Entity 類別建構式
		/// </summary>
		public IdentifyStandard2Entity()
			: base()
		{
		}
		#endregion
		...
		/// Identify_Id 欄位屬性
		/// </summary>
		[FieldSpec(Field.IdentifyId, true, FieldTypeEnum.VarChar, 20, false)]
