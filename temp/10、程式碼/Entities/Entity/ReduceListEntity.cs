...
namespace Entities
{
	...
	public partial class ReduceListEntity : Entity
	{
		...
		#region [MDY:202203XX] 2022擴充案 減免類別代碼型別調整為 NVarChar(40)
		private string _ReduceId = null;
		/// <summary>
		/// 減免類別代碼
		/// </summary>
		[FieldSpec(Field.ReduceId, true, FieldTypeEnum.NVarChar, 40, false)]
		...
		#region Data
		#region [MDY:202203XX] 2022擴充案 減免類別名稱型別調整為 NVarChar(40)
		/// <summary>
		/// 減免類別名稱
		/// </summary>
		[FieldSpec(Field.ReduceName, false, FieldTypeEnum.NVarChar, 40, true)]
		...
		/// 減免類別英文名稱
		/// </summary>
		[FieldSpec(Field.ReduceEName, false, FieldTypeEnum.NVarChar, 40, true)]
