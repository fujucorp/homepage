...
namespace Entities
{
    ...
    public class SelectAllCommand : ServiceCommand<SelectAllCommand>
    {
        #region Static Reaonly
        /// <summary>
        /// 命令的名稱定義
        /// </summary>
        public static readonly string COMMAND_NAME = "SELECT_ALL";
        ...
        /// <summary>
        /// 建構查詢所有資料命令類別物件，並指定 commandAsker、entityType、where、orderbys
        /// </summary>
        ...
        protected SelectAllCommand(CommandAsker commandAsker, Type entityType, Expression where, KeyValueList<OrderByEnum> orderbys)
            : base(COMMAND_NAME)
        {
        ...
        /// <summary>
        /// 建構查詢所有資料命令類別物件，並指定命令參數集合
        /// </summary>
        /// <param name="parameters">指定命令參數集合。</param>
        protected SelectAllCommand(ServiceParameterList parameters)
        ...
        public static SelectAllCommand Create<T>(CommandAsker commandAsker, Expression where, KeyValueList<OrderByEnum> orderbys) where T : class, IEntity
        {
            SelectAllCommand command = new SelectAllCommand(commandAsker, typeof(T), where, orderbys);
            return command;
        }
        ...
        /// <returns>成功則傳回查詢資料命令類別物件，否則傳回 null。</returns>
        public static SelectAllCommand Create(IServiceCommand command)
        {
            if (command != null && command.CommandName == SelectAllCommand.COMMAND_NAME)
            {
                return new SelectAllCommand(command.Parameters);
            }
            return null;
        }
        #endregion
        ...
        ///// <param name="orderbys">指定資料排序。</param>
        ///// <returns>成功則傳回查詢資料命令類別物件，否則傳回 null。</returns>
        //public static SelectAllCommand Create(CommandAsker commandAsker, Type entityType, Expression where, KeyValueList<OrderByEnum> orderbys)
        //{
        //    SelectAllCommand command = new SelectAllCommand(commandAsker, entityType, where, orderbys);
        //    return command;
        //}
        ...
        ///// <param name="orderbys">指定資料排序。</param>
        ///// <returns>成功則傳回查詢資料命令類別物件，否則傳回 null。</returns>
        //public static SelectAllCommand Create(CommandAsker commandAsker, string entityTypeFullName, Expression where, KeyValueList<OrderByEnum> orderbys)
        //{
        ...
        //    SelectAllCommand command = new SelectAllCommand(parameters);
        //    return command;
        //}
        #endregion
    }
