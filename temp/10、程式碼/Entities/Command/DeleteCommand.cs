...
namespace Entities
{
    ...
    public class DeleteCommand : ServiceCommand<DeleteCommand>
    {
        #region Static Reaonly
        /// <summary>
        /// 命令的名稱定義
        /// </summary>
        public static readonly string COMMAND_NAME = "DELETE";
        ...
        /// <summary>
        /// 建構刪除資料命令類別物件，並指定 commandAsker、entityType、instance
        /// </summary>
        /// <param name="commandAsker">指定命令請求者資訊。</param>
        /// <param name="entityType">指定 Entity 型別。</param>
        /// <param name="instance">指定刪除資料物件。</param>
        protected DeleteCommand(CommandAsker commandAsker, Type entityType, IEntity instance)
            : base(COMMAND_NAME)
        {
        ...
        /// <summary>
        /// 建構刪除資料命令類別物件，並指定命令參數集合
        /// </summary>
        /// <param name="parameters">指定命令參數集合。</param>
        protected DeleteCommand(ServiceParameterList parameters)
        ...
        public static DeleteCommand Create<T>(CommandAsker commandAsker, T instance) where T : class, IEntity
        {
            DeleteCommand command = new DeleteCommand(commandAsker, typeof(T), instance);
            return command;
        }
        ...
        /// <returns>成功則傳回查詢資料命令類別物件，否則傳回 null。</returns>
        public static DeleteCommand Create(IServiceCommand command)
        {
            if (command != null && command.CommandName == DeleteCommand.COMMAND_NAME)
            {
                return new DeleteCommand(command.Parameters);
            }
            return null;
        }
        #endregion
        ...
        ///// <param name="instance">指定刪除資料物件。</param>
        ///// <returns>成功則傳回查詢資料命令類別物件，否則傳回 null。</returns>
        //public static DeleteCommand Create(CommandAsker commandAsker, IEntity instance)
        //{
        //    if (instance == null)
        //    {
        //        return null;
        //    }
        //    DeleteCommand command = new DeleteCommand(commandAsker, instance.GetType(), instance);
        //    return command;
        //}
        ...
        ///// <param name="instance">指定刪除資料物件。</param>
        ///// <returns>成功則傳回查詢資料命令類別物件，否則傳回 null。</returns>
        //public static DeleteCommand Create(CommandAsker commandAsker, string entityTypeFullName, IEntity instance)
        //{
        ...
        //    DeleteCommand command = new DeleteCommand(parameters);
        //    return command;
        //}
        #endregion
    }
