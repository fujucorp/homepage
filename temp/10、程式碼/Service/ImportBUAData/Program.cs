...
namespace ImportBUAData
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region 處理 BUA 待處理序列資料
            string jobcubeType = JobCubeTypeCodeTexts.BUA;
            ...
            try
            {
                ...
                if (job != null)
                {
                    ...
                    {
                        result = fileHelper.ImportBUAJob(job, null, false, out importLog, out totalCount, out successCount);
