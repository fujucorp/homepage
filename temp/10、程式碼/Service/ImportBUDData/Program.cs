...
namespace ImportBUDData
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region 處理 BUD 待處理序列資料
            string jobcubeType = JobCubeTypeCodeTexts.BUD;
            ...
            try
            {
                ...
                if (job != null)
                {
                    ...
                    {
                        result = fileHelper.ImportBUDJob(job, null, false, out importLog, out totalCount, out successCount);
