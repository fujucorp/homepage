...
namespace ImportBUCData
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region 處理 BUC 待處理序列資料
            string jobcubeType = JobCubeTypeCodeTexts.BUC;
            ...
            try
            {
                ...
                if (job != null)
                {
                    ...
                    {
                        result = fileHelper.ImportBUCJob(job, null, false, out importLog, out totalCount, out successCount);
