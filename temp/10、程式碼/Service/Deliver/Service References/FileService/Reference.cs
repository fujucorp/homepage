...
namespace Deliver.FileService {
    ...
    public interface FileServiceSoap {
        ...
        Deliver.FileService.FTPUploadResponse FTPUpload(Deliver.FileService.FTPUploadRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/FTPUpload", ReplyAction="*")]
        System.Threading.Tasks.Task<Deliver.FileService.FTPUploadResponse> FTPUploadAsync(Deliver.FileService.FTPUploadRequest request);
    }
    ...
    public partial class FTPUploadRequest {
        ...
        public Deliver.FileService.FTPUploadRequestBody Body;
        
        public FTPUploadRequest() {
        }
        
        public FTPUploadRequest(Deliver.FileService.FTPUploadRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class FTPUploadResponse {
        ...
        public Deliver.FileService.FTPUploadResponseBody Body;
        
        public FTPUploadResponse() {
        }
        
        public FTPUploadResponse(Deliver.FileService.FTPUploadResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface FileServiceSoapChannel : Deliver.FileService.FileServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FileServiceSoapClient : System.ServiceModel.ClientBase<Deliver.FileService.FileServiceSoap>, Deliver.FileService.FileServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Deliver.FileService.FTPUploadResponse Deliver.FileService.FileServiceSoap.FTPUpload(Deliver.FileService.FTPUploadRequest request) {
        ...
        public string FTPUpload(string apData, int jobNo, string jobTypeId, string fileKind, byte[] zipContents) {
            Deliver.FileService.FTPUploadRequest inValue = new Deliver.FileService.FTPUploadRequest();
            inValue.Body = new Deliver.FileService.FTPUploadRequestBody();
            ...
            Deliver.FileService.FTPUploadResponse retVal = ((Deliver.FileService.FileServiceSoap)(this)).FTPUpload(inValue);
            return retVal.Body.FTPUploadResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Deliver.FileService.FTPUploadResponse> Deliver.FileService.FileServiceSoap.FTPUploadAsync(Deliver.FileService.FTPUploadRequest request) {
            return base.Channel.FTPUploadAsync(request);
        }
        
        public System.Threading.Tasks.Task<Deliver.FileService.FTPUploadResponse> FTPUploadAsync(string apData, int jobNo, string jobTypeId, string fileKind, byte[] zipContents) {
            Deliver.FileService.FTPUploadRequest inValue = new Deliver.FileService.FTPUploadRequest();
            inValue.Body = new Deliver.FileService.FTPUploadRequestBody();
            inValue.Body.apData = apData;
            inValue.Body.jobNo = jobNo;
            ...
            inValue.Body.fileKind = fileKind;
            inValue.Body.zipContents = zipContents;
            return ((Deliver.FileService.FileServiceSoap)(this)).FTPUploadAsync(inValue);
        }
    }
}
