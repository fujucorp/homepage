...
namespace ImportBUGData
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region 處理 BUG 待處理序列資料
            string jobcubeType = JobCubeTypeCodeTexts.BUG;
            ...
            try
            {
                ...
                if (job != null)
                {
                    ...
                    {
                        result = fileHelper.ImportBUGJob(job, null, false, out importLog, out totalCount, out successCount);
