...
namespace ImportBUBData
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region 處理 BUB 待處理序列資料
            string jobcubeType = JobCubeTypeCodeTexts.BUB;
            ...
            try
            {
                ...
                if (job != null)
                {
                    ...
                    {
                        result = fileHelper.ImportBUBJob(job, null, false, out importLog, out totalCount, out successCount);
