...
namespace ImportBUFData
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region 處理 BUF 待處理序列資料
            string jobcubeType = JobCubeTypeCodeTexts.BUF;
            ...
            try
            {
                ...
                if (job != null)
                {
                    ...
                    {
                        result = fileHelper.ImportBUFJob(job, null, false, out importLog, out totalCount, out successCount);
