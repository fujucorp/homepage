...
namespace eSchoolWeb.S
{
    ...
    /// 金融機構代碼管理
    /// </summary>
    public partial class S5600002 : BasePage
    {
        /// <summary>
        /// 初始化使用介面
        /// </summary>
        ...
        private bool GetDataAndBind()
        {
            ...
            XmlResult xmlResult = DataProxy.Current.SelectAll<BankEntity>(this, where, orderbys, out datas);
        ...
        protected void ccbtnInsert_Click(object sender, EventArgs e)
        {
            ...
            Server.Transfer("S5600002M.aspx");
        }

        protected void gvResult_PreRender(object sender, EventArgs e)
        {
            BankEntity[] datas = this.gvResult.DataSource as BankEntity[];
            ...
            {
                BankEntity data = datas[row.RowIndex];
                //資料參數
                string argument = String.Format("{0}", data.BankNo);
