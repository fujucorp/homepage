...
namespace eSchoolWeb.S
{
    ...
    /// 學年代碼維護
    /// </summary>
    public partial class S5600001 : BasePage
    {
        /// <summary>
        /// 初始化使用介面
        /// </summary>
        ...
        private bool GetDataAndBind()
        {
            ...
            XmlResult xmlResult = DataProxy.Current.SelectAll<YearListEntity>(this, where, orderbys, out datas);
        ...
        protected void ccbtnInsert_Click(object sender, EventArgs e)
        {
            ...
            Server.Transfer("S5600001M.aspx");
        }

        protected void gvResult_PreRender(object sender, EventArgs e)
        {
            YearListEntity[] datas = this.gvResult.DataSource as YearListEntity[];
            ...
            {
                YearListEntity data = datas[row.RowIndex];
                //資料參數
                string argument = String.Format("{0}", data.YearId);
