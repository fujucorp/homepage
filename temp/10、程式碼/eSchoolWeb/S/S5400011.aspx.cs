...
namespace eSchoolWeb.S
{
    ...
    /// 代收單位交易資訊統計表
    /// </summary>
    public partial class S5400011 : BasePage
    {
        ...
        protected void ccbtnReport_Click(object sender, EventArgs e)
        {
            ...
            string action = this.GetLocalized("代收單位交易資訊統計表");
            byte[] fileContent = null;

            #region [MDY:20190906] (2019擴充案) 匯出檔增加 ODS 格式
            XmlResult result = DataProxy.Current.ExportReportD2(this.Page, bankId, schIdenty, receiveType, acctSDate, acctEDate
            ...
            {
                #region [MDY:20190906] (2019擴充案) 匯出檔增加 ODS 格式
                string fileName = String.Format("代收單位交易資訊統計表.{0}", extName);
