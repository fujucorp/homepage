...
namespace eSchoolWeb.S
{
    ...
    /// 繳費單模板管理 (行員專用) (維護)
    /// </summary>
    public partial class S5600010M : BasePage
    {
        #region Keep 頁面參數
        /// <summary>
        /// 編輯模式參數
        ...
        {
            this.rdoBillFormEdition.SelectedIndex = 0;
        ...
        private void BindEditData(BillFormEntity data)
        {
            if (data == null)
            {
                this.rdoBillFormEdition.SelectedIndex = -1;
            ...
            switch (this.Action)
            {
                case ActionMode.Insert:
                    this.rdoBillFormEdition.Enabled = true;
                ...
                case ActionMode.Modify:
                    this.rdoBillFormEdition.Enabled = false;
            ...
            WebHelper.SetRadioButtonListSelectedValue(this.rdoBillFormEdition, data.BillFormEdition);
        ...
        private bool GetAndCheckEditData(out BillFormEntity data)
        {
            ...
            #region 模板類別
            data.BillFormEdition = this.rdoBillFormEdition.SelectedValue;
            if (String.IsNullOrEmpty(data.BillFormEdition))
            {
                this.ShowMustInputAlert("模板類別");
                return false;
            }
            #endregion
                ...
                switch (this.Action)
                {
                    case ActionMode.Insert:   //新增
                        #region 新增
                        {
                            ...
                            data = new BillFormEntity();
                            data.BillFormId = 0;
                            data.BillFormEdition = BillFormEditionCodeTexts.PUBLIC;
                        }
                        #endregion
                        break;
                    case ActionMode.Modify:   //修改
        ...
        protected void rdoBillFormEdition_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.trReceiveType.Visible = this.rdoBillFormEdition.SelectedValue == BillFormEditionCodeTexts.PRIVATE;
        }
    }
}