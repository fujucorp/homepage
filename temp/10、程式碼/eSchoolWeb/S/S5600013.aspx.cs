...
namespace eSchoolWeb.S
{
    ...
    /// Q&A維護
    /// </summary>
    public partial class S5600013 : BasePage
    {
        ...
        private bool GetDataAndBind()
        {
            ...
            XmlResult xmlResult = DataProxy.Current.SelectAll<QnaEntity>(this, where, orderbys, out datas);
        ...
        protected void ccbtnInsert_Click(object sender, EventArgs e)
        {
            ...
            Server.Transfer("S5600013M.aspx");
        }

        protected void gvResult_PreRender(object sender, EventArgs e)
        {
            QnaEntity[] datas = this.gvResult.DataSource as QnaEntity[];
            ...
            {
                QnaEntity data = datas[row.RowIndex];
