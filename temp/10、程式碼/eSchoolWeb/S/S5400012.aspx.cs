...
namespace eSchoolWeb.S
{
    ...
    /// 繳款通道交易資訊統計表
    /// </summary>
    public partial class S5400012 : BasePage
    {
        private bool InitialUI()
        {
            ...
            #region 繳款通道
            {
                Expression where = new Expression(ChannelSetEntity.Field.ChannelId, RelationEnum.NotIn, new string[] { ChannelHelper.SM_DEFAULT, ChannelHelper.PO });
        ...
        protected void ccbtnReport_Click(object sender, EventArgs e)
        {
            ...
            string receiveWay = this.ddlReceiveWay.SelectedValue;
            string action = this.GetLocalized("繳款通道交易資訊統計表");
            byte[] fileContent = null;

            #region [MDY:20190906] (2019擴充案) 匯出檔增加 ODS 格式
            XmlResult result = DataProxy.Current.ExportReportD3(this.Page, bankId, schIdenty, receiveType, receiveWay, acctSDate, acctEDate
            ...
            {
                #region [MDY:20190906] (2019擴充案) 匯出檔增加 ODS 格式
                string fileName = String.Format("繳款通道交易資訊統計表.{0}", extName);
