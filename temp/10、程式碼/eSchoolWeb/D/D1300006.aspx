<%@ Page Title="土地銀行 - 代收學雜費服務網 - 小於基準其他收費標準" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1300006.aspx.cs" Inherits="eSchoolWeb.D.D1300006" %>
...
<uc:Filter2 ID="ucFilter2" runat="server" OnItemSelectedIndexChanged="ucFilter2_ItemSelectedIndexChanged" ReceiveVisible="false" UIMode="Option" />
...
<div id="divResult" runat="server">
	...
	<asp:GridView ID="gvResult" runat="server" CssClass="modify"
		...
		<Columns>
			<cc:MyBoundField DataField="" LocationHeaderText="代收費用別名稱">
