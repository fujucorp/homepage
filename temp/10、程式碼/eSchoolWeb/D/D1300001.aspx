<%@ Page Title="土地銀行 - 代收學雜費服務網 - 一般收費標準檔" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1300001.aspx.cs" Inherits="eSchoolWeb.D.D1300001" %>
...
<div id="divResult" runat="server">
	...
	<asp:GridView ID="gvResult" runat="server" CssClass="modify"
		...
		<Columns>
			<cc:MyBoundField DataField="CollegeName" LocationHeaderText="院別">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
			<cc:MyBoundField DataField="MajorName" LocationHeaderText="科系">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
			<cc:MyBoundField DataField="StuGrade" LocationHeaderText="年級">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
			<cc:MyBoundField DataField="ClassName" LocationHeaderText="班別">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
			<cc:MyBoundField DataField="OrderId" LocationHeaderText="計算順序">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
