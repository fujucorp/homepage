<%@ Page Title="土地銀行 - 代收學雜費服務網 - 部別代碼" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1100002.aspx.cs" Inherits="eSchoolWeb.D.D1100002" %>
...
<asp:GridView ID="gvResult" runat="server" CssClass="modify"
	...
	<Columns>
		<cc:MyBoundField DataField="DeptId" LocationHeaderText="部別代碼">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
		<cc:MyBoundField DataField="DeptName" LocationHeaderText="部別名稱">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
