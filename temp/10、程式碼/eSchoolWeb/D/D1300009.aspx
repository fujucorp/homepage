<%@ Page Title="土地銀行 - 代收學雜費服務網 - 減免類別標準" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1300009.aspx.cs" Inherits="eSchoolWeb.D.D1300009" %>
...
<div id="divResult" runat="server">
	...
	<asp:GridView ID="gvResult" runat="server" CssClass="modify"
		...
		<Columns>
			<cc:MyBoundField DataField="ReduceId" LocationHeaderText="減免代碼">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
			<cc:MyBoundField DataField="" LocationHeaderText="減免名稱">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
			<cc:MyBoundField DataField="ReduceWay" LocationHeaderText="減免方式">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
