<%@ Page Title="土地銀行 - 代收學雜費服務網 - 就貸代碼" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1100010.aspx.cs" Inherits="eSchoolWeb.D.D11000010" %>
...
<asp:GridView ID="gvResult" runat="server" CssClass="modify"
	...
	<Columns>
		...
		<cc:MyBoundField DataField="LoanName" LocationHeaderText="就貸名稱">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
