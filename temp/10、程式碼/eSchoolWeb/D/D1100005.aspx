<%@ Page Title="土地銀行 - 代收學雜費服務網 - 科系代碼" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1100005.aspx.cs" Inherits="eSchoolWeb.D.D1100005" %>
...
<asp:GridView ID="gvResult" runat="server" CssClass="modify"
	...
	<Columns>
		<cc:MyBoundField DataField="MajorId" LocationHeaderText="科系代碼">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
		<cc:MyBoundField DataField="MajorName" LocationHeaderText="科系名稱">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
