<%@ Page Title="土地銀行 - 代收學雜費服務網 - 學分費收費標準" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1300002.aspx.cs" Inherits="eSchoolWeb.D.D1300002" %>
...
<div id="divResult" runat="server">
	...
	<asp:GridView ID="gvResult" runat="server" CssClass="modify"
		...
		<Columns>
			<cc:MyBoundField DataField="CollegeId" LocationHeaderText="院別名稱">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
			<cc:MyBoundField DataField="CreditPrice" LocationHeaderText="學分費單價" HeaderStyle-Wrap="false" DataFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right">
				<HeaderStyle Wrap="False"></HeaderStyle>
			</cc:MyBoundField>
