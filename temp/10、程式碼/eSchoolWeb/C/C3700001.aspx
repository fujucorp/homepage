<%@ Page Title="土地銀行 - 代收學雜費服務網 - 查詢繳費資料" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="C3700001.aspx.cs" Inherits="eSchoolWeb.C.C3700001" %>
...
<table id="result" class="result" summary="查詢結果" width="100%">
    ...
    <tr>
        <td>
            <div align="left">
                <asp:RadioButtonList RepeatLayout="Flow" RepeatDirection="Horizontal" ID="rdoSerachType" runat="server">
                ...
                <asp:TextBox ID="tbxSearchString" MaxLength="16" runat="server"></asp:TextBox>
            </div>
        </td>
    </tr>
</table>
