...
namespace eSchoolWeb.C
{
    ...
    /// 產生銷帳資料檔(跨學年)
    /// </summary>
    public partial class C3700008 : BasePage
    {
        private const string MyExportConfigKind = ExportConfigKindCodeTexts.CanceledBill;
        private const string MyExportFileKind = ExportFileKindCodeTexts.C3700008;
        ...
        protected void ccbtnGenFile_Click(object sender, EventArgs e)
        {
            ...
            string action = this.GetLocalized("新增產生銷帳資料檔作業");
            ...
            {
                //this.ShowActionSuccessMessage(action);
                this.ShowSystemMessage("新增產生銷帳資料檔作業成功，請稍後從【檔案清單】下載檔案");
                this.GetAndBindExportFileData(this.QueryReceiveType);
            }
            else
            {
