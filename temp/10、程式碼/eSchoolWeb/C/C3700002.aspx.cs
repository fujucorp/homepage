...
namespace eSchoolWeb.C
{
    ...
    /// 取消銷帳註記
    /// </summary>
    public partial class C3700002 : PagingBasePage
    {
        #region Property
        /// <summary>
        /// 儲存查詢的業務別碼代碼
        ...
        protected override XmlResult GetWhereAndOrderBys(out Expression where, out KeyValueList<OrderByEnum> orderbys)
        {
            ...
            {
                where.And(StudentReceiveView.Field.ReceiveWay, RelationEnum.NotEqual, String.Empty);
            }
            #endregion
        ...
        private bool InitialUI()
        {
            ...
            #region 銷帳狀態選項
            {
                CodeText[] items = new CodeText[] { 
                    new CodeText(CancelStatusCodeTexts.PAYED, CancelStatusCodeTexts.PAYED_TEXT), 
                    new CodeText(CancelStatusCodeTexts.CANCELED, CancelStatusCodeTexts.CANCELED_TEXT)
                };
                WebHelper.SetDropDownListItems(this.ddlCancelStatus, DefaultItem.Kind.All, false, items, false, true, 0, null);
            }
            #endregion
            ...
            switch (e.CommandName)
            {
                case ButtonCommandName.Modify:
                    #region 調整
                    {
                        ...
                        Server.Transfer(WebHelper.GenRNUrl("C3700002M.aspx"));
                        #endregion
                    }
                    #endregion
                    break;
