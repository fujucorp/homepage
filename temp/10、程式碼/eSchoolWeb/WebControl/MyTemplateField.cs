...
{
    /// <summary>
    /// 支援 Location 的 TemplateField 伺服器控制項
    /// </summary>
    [DefaultProperty("HeaderText")]
    [ToolboxData("<{0}:MyTemplateField runat=server></{0}:MyTemplateField>")]
    public class MyTemplateField : TemplateField
    {
        #region Override TemplateField's Method
        /// <summary>
