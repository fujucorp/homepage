...
{
    public partial class B2200003 : BasePage
    {
        #region Property
        /// <summary>
        /// 儲存業務別碼代碼的查詢條件
        ...
        private bool GetDataAndBind(string qReceiveType, string qYearID, string qTermID)
        {
            ...
            where
                ...
                .And(JobCubeView.Field.Jtypeid, RelationEnum.In, new string[] { JobCubeTypeCodeTexts.CI, JobCubeTypeCodeTexts.CP });
            #endregion
