<%@ Page Title="土地銀行 - 代收學雜費服務網 - 減免類別代碼" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1100007.aspx.cs" Inherits="eSchoolWeb.D.D1100007" %>
...
<asp:GridView ID="gvResult" runat="server" CssClass="modify"
	...
	<Columns>
		<cc:MyBoundField DataField="ReduceId" LocationHeaderText="減免類別代碼">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
		<cc:MyBoundField DataField="ReduceName" LocationHeaderText="減免類別名稱">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
