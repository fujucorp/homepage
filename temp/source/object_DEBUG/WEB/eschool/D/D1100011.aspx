<%@ Page Title="土地銀行 - 代收學雜費服務網 - 退費代碼" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1100011.aspx.cs" Inherits="eSchoolWeb.D.D1100011" %>
...
<asp:GridView ID="gvResult" runat="server" CssClass="modify"
	...
	<Columns>
		...
		<cc:MyBoundField DataField="ReturnName" LocationHeaderText="退費名稱">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
