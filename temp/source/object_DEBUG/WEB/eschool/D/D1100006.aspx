<%@ Page Title="土地銀行 - 代收學雜費服務網 - 班別代碼" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1100006.aspx.cs" Inherits="eSchoolWeb.D.D1100006" %>
...
<asp:GridView ID="gvResult" runat="server" CssClass="modify"
	...
	<Columns>
		<cc:MyBoundField DataField="ClassId" LocationHeaderText="班別代碼">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
		<cc:MyBoundField DataField="ClassName" LocationHeaderText="班別名稱">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
