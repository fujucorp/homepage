<%@ Page Title="土地銀行 - 代收學雜費服務網 - 住宿代碼" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1100008.aspx.cs" Inherits="eSchoolWeb.D.D1100008" %>
...
<asp:GridView ID="gvResult" runat="server" CssClass="modify"
	...
	<Columns>
		...
		<cc:MyBoundField DataField="DormName" LocationHeaderText="住宿名稱">
			<HeaderStyle Wrap="False"></HeaderStyle>
		</cc:MyBoundField>
