<%@ Page Title="土地銀行 - 代收學雜費服務網 - 取消銷帳註記" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="C3700002M.aspx.cs" Inherits="eSchoolWeb.C.C3700002M" %>
...
<div class="button">
    <cc:MyLinkButton ID="ccbtnOK" runat="server" LocationText="調整成未入帳" OnClick="ccbtnOK_Click"></cc:MyLinkButton>&nbsp;&nbsp;&nbsp;&nbsp;
