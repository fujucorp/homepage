<%@ Page Title="土地銀行 - 代收學雜費服務網 - 繳款通道交易資訊統計表" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="S5400012.aspx.cs" Inherits="eSchoolWeb.S.S5400012" %>
...
<tr>
    <th><%=this.GetLocalized("繳款通道") %>：</th>
    <td>
        <asp:DropDownList ID="ddlReceiveWay" runat="server"></asp:DropDownList>
    </td>
</tr>
