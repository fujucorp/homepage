<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Mobile.Master" AutoEventWireup="true" CodeBehind="student002m.aspx.cs" Inherits="eSchoolWeb.student.student002m" %>
...
<div class="button">
    ...
    <cc:MyLinkButton ID="lbtnGenSMMBarcode" runat="server" LocationText="產生超商行動條碼" OnClick="lbtnGenSMMBarcode_Click" ></cc:MyLinkButton>
    <cc:MyLinkButton ID="lbtnNetPay" runat="server" LocationText="土地銀行個人網路銀行繳款" ></cc:MyLinkButton>
    <cc:MyLinkButton ID="lbtnCardPay1" runat="server" LocationText="財金平台信用卡繳款" ></cc:MyLinkButton>
