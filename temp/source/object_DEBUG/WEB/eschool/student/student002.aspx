<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student002.aspx.cs" Inherits="eSchoolWeb.student.student002" MasterPageFile="~/MasterPage/Main2.Master" %>
...
<tr>
	<th colspan="4"><div align="center"><%=this.GetLocalized("繳費銷帳資料") %></div></th>
</tr>
<tr>
...
<tr style="display:none">
	...
	<td colspan="3"><asp:Label ID="labReceiveBankId" runat="server" Text=""></asp:Label></td>
</tr>
<tr>
	<th><%=this.GetLocalized("代收日") %>：</th>
	<td colspan="3"><asp:Label ID="labReceiveDate" runat="server" Text=""></asp:Label></td>
</tr>
<tr style="display:none">
...
<div style="text-align:left; color:red" id="divMemo" runat="server" visible="false">
</div>

<div class="button">
    <cc:MyLinkButton ID="lbtnGenPDF" runat="server" LocationText="產生PDF繳費單" OnClick="lbtnGenPDF_Click"></cc:MyLinkButton>&nbsp;&nbsp;
    <asp:Label ID="labGenBillMemo" runat="server" Text="(如要採用實體ATM、超商、臨櫃方式繳款，請點此按鈕)"></asp:Label><br /><br />
    <cc:MyLinkButton ID="lbtnNetPay" runat="server" LocationText="土地銀行個人網路銀行繳款" ></cc:MyLinkButton><br /><br />
    <cc:MyLinkButton ID="lbtnATMPay" runat="server"  LocationText="網路ATM繳款" ></cc:MyLinkButton>&nbsp;&nbsp;
    <cc:MyLinkButton ID="lbtnCardPay1" runat="server" LocationText="財金平台信用卡繳款" ></cc:MyLinkButton><br /><br />
    <cc:MyLinkButton ID="lbtnCardPay3" runat="server" LocationText="中國信託平台信用卡繳款" ></cc:MyLinkButton>&nbsp;&nbsp;
    <cc:MyLinkButton ID="lbtnUnionPay" runat="server" LocationText="銀聯卡繳款" OnClientClick="window.open('https://www.i-payment.com.tw', '_unionPay'); return false;"  ></cc:MyLinkButton><br /><br />
    <cc:MyLinkButton ID="lbtnBack" runat="server" LocationText="回上一頁" OnClick="lbtnBack_Click"></cc:MyLinkButton>&nbsp;&nbsp;
</div>
