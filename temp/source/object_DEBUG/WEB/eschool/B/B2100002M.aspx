<%@ Page Title="土地銀行 - 代收學雜費服務網 - 維護學生繳費資料" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="B2100002M.aspx.cs" Inherits="eSchoolWeb.B.B2100002M" %>
...
<tr>
	<th style="width: 25%;"><%=this.GetLocalized("學號") %>：</th>
	<td style="width: 25%;"><asp:TextBox ID="tbxStuId" runat="server" MaxLength="20"></asp:TextBox></td>
	<th style="width: 25%;"><%=this.GetLocalized("姓名") %>：</th>
	<td style="width: 25%;"><asp:TextBox ID="tbxName" runat="server" MaxLength="60"></asp:TextBox></td>
</tr>
<tr>
...
<tr>
	...
	<th><asp:Label ID="labNCCardFlag" runat="server" Text="國際信用卡繳費" style="font-size:15px; padding: 0;" ></asp:Label></th>
...
<tr>
	...
	<th><%=this.GetLocalized("減免金額") %>：</th>
	<td><asp:TextBox ID="tbxFeePayable" runat="server" MaxLength="9"></asp:TextBox></td>
</tr>
<tr>
...
<tr>
	<td colspan="4">
		...
		<asp:Literal ID="litLoanListHtml" runat="server"></asp:Literal>
		<asp:Literal ID="litReduceListHtml" runat="server"></asp:Literal>
	</td>
</tr>
...
<tr>
	...
	<td>
		<asp:Label ID="labCancelNo" runat="server" Text=""></asp:Label>&nbsp;<br />
		<asp:TextBox ID="tbxCancelNo" runat="server" MaxLength="16" Visible="false" ></asp:TextBox>
	</td>
</tr>
<tr>
...
<tr>
	<th><%=this.GetLocalized("資料建立日期") %>：</th>
	<td><asp:Label ID="labCreateDate" runat="server" Text=""></asp:Label></td>
	<th><%=this.GetLocalized("最後修改日期") %>：</th>
	<td><asp:Label ID="labUpdateDate" runat="server" Text=""></asp:Label></td>
</tr>
</table>

<div class="button">
    <cc:MyLinkButton ID="ccbtnOK" runat="server" LocationText="存檔" OnClick="ccbtnOK_Click" ></cc:MyLinkButton><br /><br />
    <cc:MyLinkButton ID="ccbtnCalc" runat="server" LocationText="計算金額及存檔" OnClick="ccbtnCalc_Click" ></cc:MyLinkButton><br /><br />
    <cc:MyLinkButton ID="ccbtnGenBill" runat="server" LocationText="產生PDF繳費單" OnClick="ccbtnGenBill_Click" ></cc:MyLinkButton>&nbsp;&nbsp;
    ...
    <cc:MyLinkButton ID="ccbtnGenReceipt" runat="server" LocationText="產生PDF繳費收據" OnClick="ccbtnGenReceipt_Click" ></cc:MyLinkButton>&nbsp;&nbsp;
    <cc:MyLinkButton ID="ccbtnGenEngReceipt" runat="server" LocationText="產生英文PDF繳費收據" OnClick="ccbtnGenEngReceipt_Click" ></cc:MyLinkButton><br /><br />
