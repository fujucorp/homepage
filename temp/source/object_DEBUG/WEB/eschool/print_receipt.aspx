<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print_receipt.aspx.cs" Inherits="eSchoolWeb.print_receipt" %>
...
<head>
    ...
    <script  type="text/javascript">
        if (self === top) {
            ...
            top.location = '/print_receipt.aspx';
        }
    </script>
    <script  type="text/javascript">
