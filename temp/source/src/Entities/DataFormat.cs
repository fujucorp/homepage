    ...
    public abstract class DataFormat
    {
        ...
        public static string GetUserPXXEncode(string value)
        {
            try
            {
                ...
                return lbHelper.GetTextDESEncode(value, UserPXXKey);
                #endregion
            }
            catch (Exception)
            {
        ...
        public static string GetUserPXXDecode(string hexData)
        {
            try
            {
                ...
                Fuju.Help.LBHelper lbHelper = new Fuju.Help.LBHelper();
                return lbHelper.GetTextDESDecode(hexData, UserPXXKey);
                #endregion
            }
            catch (Exception)
            {
        ...
        public static string GetSysCWordEncode(string value)
        {
            try
            {
                ...
                Fuju.Help.LBHelper lbHelper = new Fuju.Help.LBHelper();
                return lbHelper.GetTextDESEncode(value, SysCWordKey);
                #endregion
            }
            catch (Exception)
            {
        ...
        public static string GetSysCWordDecode(string hexData)
        {
            try
            {
                ...
                Fuju.Help.LBHelper lbHelper = new Fuju.Help.LBHelper();
                return lbHelper.GetTextDESDecode(hexData, SysCWordKey);
                #endregion
            }
            catch (Exception)
            {
