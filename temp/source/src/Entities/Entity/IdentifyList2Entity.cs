...
namespace Entities
{
	...
	public partial class IdentifyList2Entity : Entity
	{
		public const string TABLE_NAME = "Identify_List2";
		...
		public abstract class Field
		{
			...
			#region [MDY:20220808] 2022擴充案 身分註記英文名稱 新增欄位
			/// <summary>
			/// 身分註記英文名稱
			/// </summary>
		...
		#region Data
		#region [MDY:20220808] 2022擴充案 身分註記名稱型別調整為 NVarChar(140)
		/// <summary>
		/// 身分註記名稱
		/// </summary>
		[FieldSpec(Field.IdentifyName, false, FieldTypeEnum.NVarChar, 140, true)]
		...
		#region [MDY:20220808] 2022擴充案 身分註記英文名稱 新增欄位並調整為 NVarChar(140)
		/// <summary>
		/// 身分註記英文名稱
		/// </summary>
		[FieldSpec(Field.IdentifyEName, false, FieldTypeEnum.NVarChar, 140, true)]
