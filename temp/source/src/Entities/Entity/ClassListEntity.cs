...
namespace Entities
{
	...
	public partial class ClassListEntity : Entity
	{
		public const string TABLE_NAME = "Class_List";
		...
		public abstract class Field
		{
			...
			#region [MDY:20220808] 2022擴充案 班別英文名稱 新增欄位
			/// <summary>
			/// 班別英文名稱
			/// </summary>
		...
		#region Data
		#region [MDY:20220808] 2022擴充案 班別名稱型別調整為 NVarChar(140)
		/// <summary>
		/// 班別名稱
		/// </summary>
		[FieldSpec(Field.ClassName, false, FieldTypeEnum.NVarChar, 140, true)]
		...
		#region [MDY:20220808] 2022擴充案 班別英文名稱 新增欄位並調整為 NVarChar(140)
		/// <summary>
		/// 班別英文名稱
		/// </summary>
		[FieldSpec(Field.ClassEName, false, FieldTypeEnum.NVarChar, 140, true)]
