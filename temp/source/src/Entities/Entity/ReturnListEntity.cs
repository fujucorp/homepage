...
namespace Entities
{
	...
	public partial class ReturnListEntity : Entity
	{
		public const string TABLE_NAME = "Return_List";
		...
		public abstract class Field
		{
			...
			/// 退費名稱 欄位名稱常數定義
			/// </summary>
			public const string ReturnName = "Return_Name";

			#region [MDY:20220808] 2022擴充案 就貸英文名稱 新增欄位
			/// <summary>
			/// 退費英文名稱
			/// </summary>
			public const string ReturnEName = "Return_EName";
			#endregion
			#endregion
		...
		#region [MDY:20220808] 2022擴充案 退費代碼型別調整為 NVarChar(140)
		private string _ReturnId = null;
		/// <summary>
		/// 退費代碼
		/// </summary>
		[FieldSpec(Field.ReturnId, true, FieldTypeEnum.NVarChar, 140, false)]
		...
		#region Data
		#region [MDY:20220808] 2022擴充案 退費名稱型別調整為 NVarChar(140)
		/// <summary>
		/// 退費名稱
		/// </summary>
		[FieldSpec(Field.ReturnName, false, FieldTypeEnum.NVarChar, 140, true)]
		...
		#region [MDY:20220808] 2022擴充案 退費英文名稱 新增欄位並調整為 NVarChar(140)
		/// <summary>
		/// 退費英文名稱
		/// </summary>
		[FieldSpec(Field.ReturnEName, false, FieldTypeEnum.NVarChar, 140, true)]
		public string ReturnEName
		{
			get;
			set;
		}
