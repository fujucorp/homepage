...
{
	/// <summary>
    /// 一般收費標準 資料表 Entity 類別
	/// </summary>
	[Serializable]
	[EntitySpec(TABLE_NAME, TableTypeEnum.Table)]
	public partial class GeneralStandardEntity : Entity
	{
		public const string TABLE_NAME = "General_Standard";

		#region Field Name Const Class
		/// <summary>
		/// GeneralStandardEntity 欄位名稱定義抽象類別
		/// </summary>
		...
		#region Constructor
		/// <summary>
		/// GeneralStandardEntity 類別建構式
		/// </summary>
		public GeneralStandardEntity()
			: base()
		{
		}
		#endregion
		...
		#region [MDY:20220808] 2022擴充案 系所代碼型別調整為 NVarChar(140)
		private string _MajorId = null;
		/// <summary>
		/// Major_Id 欄位屬性
		/// </summary>
		[FieldSpec(Field.MajorId, true, FieldTypeEnum.NVarChar, 140, false)]
		...
		#region [MDY:20220808] 2022擴充案 班別代碼型別調整為 NVarChar(140)
		private string _ClassId = null;
		/// <summary>
		/// Class_Id 欄位屬性
		/// </summary>
		[FieldSpec(Field.ClassId, true, FieldTypeEnum.NVarChar, 140, false)]
		...
		/// Order_Id 欄位屬性
		/// </summary>
		[FieldSpec(Field.OrderId, false, FieldTypeEnum.Integer, true)]
		public int? OrderId
		{
			get;
			set;
