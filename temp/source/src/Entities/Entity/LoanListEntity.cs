...
namespace Entities
{
	...
	public partial class LoanListEntity : Entity
	{
		public const string TABLE_NAME = "Loan_List";
		...
		#region [MDY:20220808] 2022擴充案 就貸代碼型別調整為 NVarChar(140)
		private string _LoanId = null;
		/// <summary>
		/// 就貸代碼
		/// </summary>
		[FieldSpec(Field.LoanId, true, FieldTypeEnum.NVarChar, 140, false)]
		...
		#region Data
		#region [MDY:20220808] 2022擴充案 就貸名稱型別調整為 NVarChar(140)
		/// <summary>
		/// 就貸名稱
		/// </summary>
		[FieldSpec(Field.LoanName, false, FieldTypeEnum.NVarChar, 140, true)]
		...
		#region [MDY:20220808] 2022擴充案 就貸英文名稱 新增欄位並調整為 NVarChar(140)
		/// <summary>
		/// 就貸英文名稱
		/// </summary>
		[FieldSpec(Field.LoanEName, false, FieldTypeEnum.NVarChar, 140, true)]
