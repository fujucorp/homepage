...
namespace Entities
{
	...
	public partial class MajorListEntity : Entity
	{
		...
		public abstract class Field
		{
			...
			#region [MDY:20220808] 2022擴充案 系所英文名稱 新增欄位
			/// <summary>
			/// 系所英文名稱
			/// </summary>
		...
		#region Data
		#region [MDY:20220808] 2022擴充案 系所名稱型別調整為 NVarChar(140)
		/// <summary>
		/// 系所名稱
		/// </summary>
		[FieldSpec(Field.MajorName, false, FieldTypeEnum.NVarChar, 140, true)]
		...
		#region [MDY:20220808] 2022擴充案 系所英文名稱 新增欄位並調整為 NVarChar(140)
		/// <summary>
		/// 系所英文名稱
		/// </summary>
		[FieldSpec(Field.MajorEName, false, FieldTypeEnum.NVarChar, 140, true)]
