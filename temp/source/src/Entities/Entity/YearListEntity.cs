...
namespace Entities
{
	...
	public partial class YearListEntity : Entity
	{
		...
		public abstract class Field
		{
			...
			#region [MDY:20220808] 2022擴充案 學年英文名稱、資料啟用 新增欄位
			/// <summary>
			/// 學年英文名稱
			/// </summary>
		...
		#region [MDY:20220808] 2022擴充案 學年英文名稱、資料啟用 新增欄位並學年英文名稱調整為 NVarChar(140)
		/// <summary>
		/// 學年英文名稱
		/// </summary>
		[FieldSpec(Field.YearEName, false, FieldTypeEnum.NVarChar, 140, true)]
