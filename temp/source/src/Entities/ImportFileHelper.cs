...
namespace Entities
{
    ...
    public sealed class ImportFileHelper : IDisposable
    {
        ...
        public Result ImportBUAJob(JobcubeEntity job, Encoding encoding, bool isBatch, out string logmsg, out Int32 totalCount, out Int32 successCount)
        {
            ...
            #region [MDY:20220808] 2022擴充案 因為要判斷是否啟用英文資料，所以取得商家代號資料程式段搬到這裡
            ...
            #region [MDY:20220808] 2022擴充案 收入科目英文名稱、備註項目英文標題
                ...
                switch (fileType)
                {
                    ...
                    case "xlsx":
                        #region Excel檔格式
                        {
                            ...
                            #region [MDY:20220808] 2022擴充案 收集收入科目英文名稱、備註項目英文標題
                            if (isEngEnabled)
                            {
            ...
            if ((receiveItemNames != null && receiveItemNames.Length > 0) || (memoTitles != null && memoTitles.Length > 0))
            {
                ...
                if (schoolRid == null)
                {
                    ...
                    #region [MDY:20220808] 2022擴充案 對應欄位已擴充，不再使用，固定設為 空白
                    #region [OLD]
            ...
            #region [MDY:20220808] 2022擴充案 因為要判斷是否啟用英文資料，所以取得商家代號資料程式段往前搬
            #region [OLD] 取得商家代號資料
            //SchoolRTypeEntity school = null;
            //{
            //    Expression where = new Expression(SchoolRTypeEntity.Field.ReceiveType, receiveType);
                ...
                switch (fileType)
                {
                    ...
                    case "ods":
                        #region Ods 轉 DataTable
                        {
                            ...
                            using (MemoryStream ms = new MemoryStream(fileContent))
                            {
                                //[MDY:20220820] Ods2DataTable() 的 isBatch 意義與原參數用意相反，所以要用 !isBatch
            ...
            #region 使用交易將 DataTable 逐筆存入資料庫
            {
                    ...
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        MajorListEntity major = null;
                        {
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.ClassId))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 班別英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                        ...
                        DormListEntity dorm = null;
                        {
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.LoanId))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 就貸英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                        ...
                        IdentifyList6Entity identify6 = null;
                        {
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.IdentifyId1))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 身分註記01英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.IdentifyId2))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 身分註記02英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.IdentifyId3))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 身分註記03英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.IdentifyId4))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 身分註記04英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.IdentifyId5))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 身分註記05英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                            ...
                            if (fieldNames.Contains(MappingreXlsmdbEntity.Field.IdentifyId6))
                            {
                                ...
                                #region [MDY:20220808] 2022擴充案 身分註記06英文名稱
                                if (isEngEnabled)
                                {
                                    //沒有英文名稱則以中文名稱取代英文名稱
                ...
                if (importResult.IsSuccess && schoolRid != null)
                {
                    ...
                    else
                    {
                        ...
                        #region [MDY:20220808] 2022擴充案 備註項目英文標題
                        {
                            //比照中文標題，以上傳的資料為準
                            string[] fields = new string[SchoolRidEntity.MemoTitleMaxCount] {
            ...
            DataTable table = null;
            {
                ...
                try
                {
                    ...
                    using (MemoryStream ms = new MemoryStream(fileContent))
                    {
                        ...
                        {
                            //[MDY:20220820] Ods2DataTable() 的 isBatch 意義與原用意相反，所以要用 !isBatch
