<%@ Page Title="土地銀行 - 代收學雜費服務網 - 繳費單模板管理" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="S5600010M.aspx.cs" Inherits="eSchoolWeb.S.S5600010M" %>
...
<table id="result" class="result" summary="查詢結果" width="100%">
    <tr>
        ...
        <td>
            <asp:RadioButtonList ID="rdoBillFormEdition" AutoPostBack="true" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server" OnSelectedIndexChanged="rdoBillFormEdition_SelectedIndexChanged">
                <asp:ListItem Value="2">公版&nbsp;</asp:ListItem>
                <asp:ListItem Value="3">專屬</asp:ListItem>
            </asp:RadioButtonList>
        </td>
    </tr>
