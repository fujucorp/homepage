<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bank_login.aspx.cs" Inherits="eSchoolWeb.bank_login" %>
...
<head>
    ...
    <script  type="text/javascript">
        if (self === top) {
            ...
            top.location = '/bank_login.aspx';
        }
    </script>
    <script  type="text/javascript">
        function checkInput(event) {
            if (event.keyCode == 13) {
                var oInput1 = $("#<%=txtUserId.ClientID%>");
                if (oInput1.val().prune() == "") {
                    oInput1.focus();
                    return false;
                }
                var oInput2 = $("#<%=txtPXX.ClientID%>");
                        ...
                        <div id="loginBox">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtUserId" runat="server" MaxLength="20"></asp:TextBox></td>
                                </tr>
                                <tr>
