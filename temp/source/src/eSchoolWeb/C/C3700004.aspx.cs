...
namespace eSchoolWeb.C
{
    ...
    /// 下載銷帳資料
    /// </summary>
    public partial class C3700004 : BasePage
    {
        private const string MyExportConfigKind = ExportConfigKindCodeTexts.CanceledBill;
        ...
        private void GetAndBindMemoTitles(string receiveType, string yearId, string termId, string depId, string receiveId)
        {
            ...
            else
            {
                ...
                //this.trMemoRow3.Visible = this.chkMemo09.Visible || this.chkMemo10.Visible || this.chkMemo11.Visible || this.chkMemo12.Visible;
                //this.trMemoRow4.Visible = this.chkMemo13.Visible || this.chkMemo14.Visible || this.chkMemo15.Visible || this.chkMemo16.Visible;
                //this.trMemoRow5.Visible = this.chkMemo17.Visible || this.chkMemo18.Visible || this.chkMemo19.Visible || this.chkMemo20.Visible;
                //this.trMemoRow6.Visible = this.chkMemo21.Visible;
                #endregion
            }
        }
        ...
        protected void ccbtnDownload_Click(object sender, EventArgs e)
        {
            ...
            if (this.rbtReceiveDate.Checked || this.rbtAccountDate.Checked)
            {
            ...
            string action = this.GetLocalized("下載銷帳資料");
