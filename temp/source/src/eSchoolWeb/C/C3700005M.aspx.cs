...
namespace eSchoolWeb.C
{
    ...
    /// 還原銷帳註記 (維護)
    /// </summary>
    public partial class C3700005M : BasePage
    {
        /// <summary>
        /// 備註數量
        /// </summary>
        ...
        private bool GetQueryData(out SchoolRidEntity schoolRid, out StudentReceiveView studentReceive, out StudentMasterEntity student)
        {
            ...
            #region StudentReceiveView
            {
                ...
                Expression where = new Expression(StudentReceiveView.Field.ReceiveType, this.EditReceiveType)
                    ...
                    .And(StudentReceiveEntity.Field.CancelFlagFields, RelationEnum.NotEqual, null)
                    .And(StudentReceiveEntity.Field.CancelFlagFields, RelationEnum.NotEqual, String.Empty)
                    .And(new Expression(StudentReceiveView.Field.ReceiveWay, null).Or(StudentReceiveView.Field.ReceiveWay, String.Empty));
                #endregion
        ...
        {
            //還原相關欄位，並清空 StudentReceive.CancelFlagFields 
            ...
            #region 更新欄位
            string action = this.GetLocalized("還原銷帳註記");
            ...
            string[] args = data.CancelFlagFields.Split(new char[] { ',' });
            if (args.Length != 7)
            {
                //[TODO] 固定顯示訊息的收集
            ...
            string cancelflag = args[0];
            string receivedate = args[1];
            string accountdate = args[2];
            string receivetime = args[3];
            string canceldate = args[4];
            string receiveway = args[5];
            string receivebankid = args[6];


            KeyValueList fieldValues = new KeyValueList();
            fieldValues.Add(StudentReceiveEntity.Field.CancelFlag, cancelflag);
            ...
            fieldValues.Add(StudentReceiveEntity.Field.CancelFlagFields, string.Empty);
            #endregion
            ...
            if (xmlResult.IsSuccess)
            {
                ...
                else
                {
                    ...
                    this.ShowActionSuccessAlert(action, "C3700005.aspx");
                }
            }
            else
            {
