...
namespace eSchoolWeb
{
    ...
    public class Fisc
    {
        ...
        #region [OLD] Checkmarx 不允許用 TripleDESCryptoServiceProvider
        ///// <summary>
        ///// 3DES ECB 解密
        ///// </summary>
        ...
        public static string GetDecodedChangeKey(string encodedNewKey, string checkValue, string oldKey, out string newKey)
        {
            ...
            if (String.IsNullOrEmpty(errmsg))
            {
                ...
                if (String.IsNullOrEmpty(errmsg))
                {
                    ...
                    errmsg = Fuju.Web.Focas.AlipayHelper.Decrypt3DES(valueBytes, keyBytes, out newKey);
                    #endregion
                    ...
                    if (String.IsNullOrEmpty(errmsg))
                    {
                        ...
                        if (String.IsNullOrEmpty(errmsg2))
                        {
                            ...
                            if (String.IsNullOrEmpty(errmsg2))
                            {
                                ...
                                errmsg2 = Fuju.Web.Focas.AlipayHelper.Encrypt3DES(value2Bytes, key2Bytes, out tmp);
                                #endregion
