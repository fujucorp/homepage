<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alipay_d.aspx.cs" Inherits="eSchoolWeb.alipay_d" %>
                    ...
                    <div id="main">
                        ...
                        <div id="loginBox">
                            <table>
                                ...
                                <tr>
                                    <th><%= GetLocalized("手續費") %>：</th>
                                    <td><asp:TextBox ID="txtCharge" runat="server" ReadOnly="True" BackColor="#FF5050"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <th><%= GetLocalized("應繳總額") %>：</th>
                                    <td><asp:TextBox ID="txtTotalAmount" runat="server" ReadOnly="True" BackColor="#FF5050"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div class="button">
