<%@ Page Title="土地銀行 - 代收學雜費服務網 - 上傳已產生虛擬帳號就貸資料" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="D1500005.aspx.cs" Inherits="eSchoolWeb.D.D1500005" %>
...
<tr id="trWaitingMsg" style="display:none">
    <td colspan="2" align="center">
        <%= GetLocalized("檔案上傳相當耗時，請耐心等待") %><br />
