...
namespace Helpers
{
    ...
    public partial class DataServiceHelper
    {
            ...
            , out int count)
        {
            ...
            {
                #region [MDY:20220910] Checkmarx - Improper Resource Shutdown or Release 誤判調整
                dbLogger = new DBLogger(commandAsker.UserQual, commandAsker.UnitId, commandAsker.FuncId, commandAsker.UserId);
                _Factory.SetDBLogger(dbLogger);
                #endregion
            ...
            {
                return new Result(false, "新增資料失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out int[] failIndexs)
        {
            ...
            {
                return new Result(false, "新增多筆資料失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out int count)
        {
            ...
            {
                return new Result(false, "更新資料失敗", CoreStatusCode.S_UPDATE_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out int count)
        {
            ...
            {
                return new Result(false, "刪除資料失敗", CoreStatusCode.S_DELETE_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out int[] failIndexs)
        {
            ...
            {
                return new Result(false, "刪除多筆資料失敗", CoreStatusCode.S_DELETE_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out Entity[] datas, out int totalCount)
        {
            ...
            {
                return new Result(false, "查詢資料失敗", CoreStatusCode.S_SELECT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out Entity[] datas)
        {
            ...
            {
                return new Result(false, "查詢多筆資料失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out int count)
        {
            ...
            {
                return new Result(false, "查詢資料筆數失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out LogonUser data)
        {
            ...
            {
                return new Result(false, "行員登入失敗", CoreStatusCode.S_EXECUTE_SQL_COMMAND_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out LogonUser data)
        {
            ...
            {
                return new Result(false, "學校登入失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out LogonUser data)
        {
            ...
            {
                return new Result(false, "學生登入失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out string data)
        {
            ...
            {
                return new Result(false, "檢查登入與功能狀態失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
        ...
        public virtual Result UserLogout(IServiceCommand command, out CommandAsker commandAsker)
        {
            ...
            {
                return new Result(false, "使用者登出失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out FilterOption data)
        {
            ...
            try
            {
                ...
                #region 查詢商家代號資料
                {
                    ...
                    #region [MDY:20220910] Checkmarx - Heuristic Parameter Tampering 誤判調整
                    #region [OLD]
                    //DataTable dt = null;
                    //result = _Factory.GetDataTable(sql, parameters, 0, 0, out dt);
                    #endregion

                    ReceiveRTypeView[] authReceiveTypes = null;
                    result = _Factory.SelectSql<ReceiveRTypeView>(sql, parameters, 0, 0, out authReceiveTypes);
                    #endregion
                    ...
                    if (result.IsSuccess)
                    {
                        ...
                        if (authReceiveTypes != null && authReceiveTypes.Length > 0)
                        {
                            #region 第一筆的 cFlag
                            {
                                ReceiveRTypeView authReceiveType = authReceiveTypes[0];
                                firstReceiveType = authReceiveType.ReceiveType ?? String.Empty;
                                firstCFlag = authReceiveType.CFlag.HasValue ? authReceiveType.CFlag.ToString() : String.Empty;
                                firstEngEnabled = authReceiveType.IsEngEnabled();
                            }
                            #endregion

                            #region 逐筆處理
                            {
                                CodeText[] items = new CodeText[authReceiveTypes.Length];
                                int idx = 0;
                                foreach (ReceiveRTypeView authReceiveType in authReceiveTypes)
                                {
                                    string code = authReceiveType.ReceiveType ?? String.Empty;
                                    string schName = authReceiveType.SchName ?? String.Empty;
                                    string schEName = authReceiveType.SchEName ?? String.Empty;
                                    bool engEnabled = authReceiveType.IsEngEnabled();
                                    string text = null;
                                    if (isEngUI && engEnabled && !String.IsNullOrEmpty(schEName))
                                    {
                                        text = schEName;
                                    ...
                                    {
                                        selectedReceiveType = code;
                                        selectedCFlag = authReceiveType.CFlag.HasValue ? authReceiveType.CFlag.ToString() : String.Empty;
                                        selectedEngEnabled = engEnabled;
                                    }
                                    idx++;
                                }
                ...
                {
                    #region [MDY:20220912] checkmarx - Heuristic Parameter Tampering 誤判調整
                    #region [OLD]
                    //DataTable dt = null;
                    ...
                    if (result.IsSuccess)
                    {
                        ...
                        if (recevieConfig != null)
                        {
                            defaultYearID = recevieConfig.DefaultYearId;
                            defaultTermID = recevieConfig.DefaultTermId;
                        }
                        #endregion
                    }
                    else
            ...
            {
                return new Result(false, "取得主要條件選項資料失敗", CoreStatusCode.S_INSERT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
            ...
            , out CodeText[] datas)
        {
            ...
            {
                return new Result(false, "取得資料選項陣列失敗", CoreStatusCode.S_SELECT_DATA_FAILURE, ex);
            }
            finally
            {
                if (dbLogger != null)
